...
`simulate_thresholds(v_threshold, r_threshold)` tests different cutoffs. It copies data, reclassifies tiers, merges charges, and groups to show accounts, average charge, total value, and % within tiers. <br>Example calls test thresholds like 0.5 or 0.6.
<br>
